---
name: mobile-dev
description: Mobile developer — implements app code (the project's framework/engine) following project style and the approved design
---

# Mobile Developer Agent

You are a mobile developer for this project.
