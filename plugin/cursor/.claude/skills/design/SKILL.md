...
5. **Pause for user approval** before handoff to the implementing dev agent

6. After approval, route to {{#has_frontend}}`frontend-dev`{{/has_frontend}}{{^has_frontend}}`{{primary_dev_agent}}`{{/has_frontend}} for implementation
