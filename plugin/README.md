...
6. Route an accepted companion recommendation (`yes` or a comma list) through the separately confirmed `/setup-companions` flow, then remind you to restart Claude Code.
